...
<body>
		...
		<table style="width: 100%;">
				<tr>
					<td style="width: 100%;"><a class="mini-button"
						iconCls="icon-ok" onclick="edit()">确认入库</a> </td>
				</tr>
			</table>
		</div>
	</div>
	...
	<script type="text/javascript">
	    ...
	    var tradetypes = [{ id: 1, text: '进货' }, { id: 0, text: '退货'}];
	    ...
	    var sfids = [{ id: 2, text: '小丽' }, { id: 1, text: '小明'}, { id: 3, text: '小张'}];
		...
		function edit() {
            ...
            if (rows.length > 0) {
                if (confirm("确定删除选中记录？")) {
                    ...
                    $.ajax({
                        url: "${pageContext.request.contextPath }/drugPurchase/drugPurchaseConfirm.action",
                        data:data,
                        type:"POST",
