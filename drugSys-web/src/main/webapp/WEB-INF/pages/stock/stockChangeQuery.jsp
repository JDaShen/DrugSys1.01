...
<body>
	    ...
	    <div class="mini-toolbar" style="text-align:center;line-height:30px;" borderStyle="border:0;">
	       <label >所在仓库：</label>
	    	<input id="combo1" class="mini-combobox" name="from"  style="width:150px;" textField="wname" valueField="wid" emptyText="请选择..."
					    url="${pageContext.request.contextPath }/warehouse/getWarehouse.action" value=" "   allowInput="true" showNullItem="true" nullItemText="请选择..."/>   </td>	
									<td colspan="3">
          	<label >商品名：</label>
          <!-- 通过id选择器获取值发送请求 -->
    ...
    <div id="dept_grid" class="mini-datagrid" style="width:100%;height:200px;" 
        url="${pageContext.request.contextPath }/summary/stockSummary.action"  idField="id"
