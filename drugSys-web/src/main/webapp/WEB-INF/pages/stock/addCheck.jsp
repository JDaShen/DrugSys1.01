	...
	<!-- content begin background:#B0B0B0-->
			<div class="container" style="margin-top: 20px;box-shadow: 3px 3px 10px;width:800px;margin-left:30px">
					<div class="row">
							...
							<tr>
									<td>盘点单号：</td>
									<td colspan="6"><span id="dId" style="color:red"><span id="orderId">PD2017111701</span></span></td>
									<td>            
									</td>
							</tr>
								<tr>
   ...
   <!--
            ...
            <table style="width:100%;">
                <tr>
                    <td style="width:100%;">
                        ...
                        <span class="separator"></span>
                        <a class="mini-button" iconCls="icon-save" onclick="doAdd()" plain="true">提交</a>          
                    </td>
    ...
    >
        <div property="columns">
            ...
            <div field="reals" width="100" allowSort="true" >仓库数量
            </div>  
             <div field="rqty" width="100" allowSort="true" >盘点数量
     ...
     <script type="text/javascript">
       ...
       var str;
         window.onload = function generateId(){
    	  //据时间自动生成单号
    	    var time2 = new Date().Format("PDyyyyMMddhhmmss");
    	  	str = time2+"";
       ...
       function doAdd(){
    	  var date =new Date(); 
    	   ...
    	   var sfid =mini.get("combo3").getSelected().sfid;
    	 	...
    	 	var arr = {"wid":wid,"date":date,"sfid":sfid,"cid":str,"comment":".."};
