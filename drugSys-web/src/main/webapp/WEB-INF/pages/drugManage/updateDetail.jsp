...
<body>    
    ...
    <form id="drugForm" method="post" style="border:solid 1px #aaa;padding:3px;">
        <input name="ddid" class="mini-hidden" />
        <div style="padding-left:11px;padding-bottom:5px;">
            <table style="table-layout:fixed;">
                <tr>
                	<td >类别编号：</td>
                    <td >    
                        <input name="ddid" class="mini-textbox" readonly="readonly" required="true"  emptyText="请输入编号"/>
                    </td>
                    <td >类别名称：</td>
                    <td >    
    ...
    <script type="text/javascript">
        ...
        function UpdateData() {
            ...
            $.ajax({
                url: "${pageContext.request.contextPath }/drugMC/updateDetail.action",
                type: "post",
                data: json,
        ...
        function SetData(data) {
            if (data.action == "edit") {
                ...
                $.ajax({
                    url: "${pageContext.request.contextPath }/drugMC/getDetailById.action?ddid=" + data.ddid,
                    cache: false,
                    success: function (text) {
                        ...
                        onDeptChanged();
                        mini.getbyName("ddname").setValue(o.ddname);
                    }
                });
            }
        }
