...
<body>
    ...
    <form id="form1" method="post">
        ...
        <table>
            <tr>
                ...
                <td  colspan="3" >    
                    <input name="levelid" class="mini-textbox" required="true" readonly="readonly"/>
                </td>
    ...
    <script type="text/javascript">
        ...
        function SaveData() {
            ...
            $.ajax({
                url: "${pageContext.request.contextPath }/updateVipLeve.action",
                type: "post",
                data: json,
        ...
        function SetData(data) {
            if (data.action == "edit") {
                ...
                $.ajax({
                    url: "${pageContext.request.contextPath }/getLivelById.action?levelId=" + data.id,
                    cache: false,
                    success: function (text) {
